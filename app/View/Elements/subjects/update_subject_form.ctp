...
<div class="block block-themed">
    <div class="block-header bg-success">
        ...
        <h3 class="block-title">Update A subject</h3>
    </div>
    <div class="block-content">
            <?php echo $this->Form->create('Subject', array('class'=>'form-horizontal push-5-t'));?>
            <div class="form-group">
                <label class="col-xs-12" for="register1-username">Name</label>
                <div class="col-xs-12">
                    <?php echo $this->Form->input('name', array('class'=>'form-control', 'label'=>false,'placeholder'=>'Enter subject Name here...')); ?>
...
<!--        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-xs-12">
                    <?php     echo $this->Form->submit('Add subject', array('class' => 'btn btn-sm btn-success',  'title' => 'Click here to add a subject') ); ?>
                </div>
            </div>
