...
<div class="block block-themed">
    <div class="block-header bg-success">
        ...
        <h3 class="block-title">Update Examination</h3>
    </div>
    <div class="block-content">
        <?php echo $this->Form->create('Exam', array('class'=>'form-horizontal push-5-t'));?>
        <div class="form-group">
            <label class="col-xs-12" for="register1-username">Exam Name</label>
            <div class="col-xs-12">
        ...
        <div class="form-group">
            <div class="col-xs-12">
                <?php     echo $this->Form->submit('Update Exam', array('class' => 'btn btn-sm btn-success',  'title' => 'Click here to add the user') ); ?>
            </div>
        </div>
