...
<div class="content bg-white border-b">
    <div class="row items-push text-uppercase">
        ...
        <div class="col-xs-6 col-sm-3">
            <div class="font-w700 text-gray-darker animated fadeIn">No of Students Enrolled</div>
            <div class="text-muted animated fadeIn"><small><i class="si si-calendar"></i> Current Session</small></div>
            <a class="h2 font-w300 text-primary animated flipInX" href="#"><?php echo $current_session; ?></a>
        </div>
        <div class="col-xs-6 col-sm-3">
        <div class="font-w700 text-gray-darker animated fadeIn">No of Staff</div>
        <div class="text-muted animated fadeIn"><small><i class="si si-calendar"></i> Current Session</small></div>
        <a class="h2 font-w300 text-primary animated flipInX" href="#"><?php echo $current_session; ?></a>
        </div>
    </div>
                        ...
                        <div class="js-slider remove-margin-b" data-slider-autoplay="true" data-slider-autoplay-speed="2500">
                            <div>
                                <table class="table remove-margin-b font-s13">
                                    ...
                                    <tr>
                                        <td class="font-w600">
                                            <a href="javascript:void(0)"><?php echo $notice['NoticeBoard']['title']; ?></a>
                                        </td>
                                        <td class="font-w600">                                            <a href="javascript:void(0)"><?php echo $notice['NoticeBoard']['content']; ?></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                    </tbody>
